...
export const getSmileyForIndexGeneral = (index) => {
    let smiley = 'smiley-green';
    if(index <= 6){

    }else if (index <= 9){
        smiley = 'smiley-yellow';
    }else if (index <= 10){
        smiley = 'smiley-red';
    }
    return smiley;
...
export const getSmileyForIndexAtRisk = (index) => {
    let smiley = 'smiley-green';
    if(index <= 3){
